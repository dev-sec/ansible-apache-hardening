...
[![Ansible Galaxy](https://img.shields.io/badge/galaxy-apache--hardening-660198.svg)][3]

## Description

This role provides secure apache configuration. It is intended to be compliant with the [DevSec apache Baseline](https://github.com/dev-sec/apache-baseline).
...
```
# fast test on one machine
KITCHEN_YAML=".kitchen.vagrant.yml" bundle exec kitchen test apache-ansible-19-ubuntu-1404

# test on all machines
KITCHEN_YAML=".kitchen.vagrant.yml" bundle exec kitchen test

# for development
KITCHEN_YAML=".kitchen.vagrant.yml" bundle exec kitchen create apache-ansible-19-ubuntu-1404
KITCHEN_YAML=".kitchen.vagrant.yml" bundle exec kitchen converge apache-ansible-19-ubuntu-1404
```
...
[3]: https://galaxy.ansible.com/dev-sec/apache-hardening/
